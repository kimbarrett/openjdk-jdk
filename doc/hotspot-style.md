...
might appear jarring and reduce readability.   However, experience in
some other code bases suggests this isn't a significant problem and
can even be beneficial, as it makes HotSpot-specific facilities and
Standard Library facilities easily distinguishable.
