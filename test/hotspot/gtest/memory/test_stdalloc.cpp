...
// Test Standard-style allocators, using std::vector.  We use std::vector
// because it allows testing of move operations in a way no other standard
// container supports, using std::vector::data.
//
// CHeapAllocator
...
template<typename T>
using ResourceAreaVector = std::vector<T, ResourceAreaAllocator<T>>;
