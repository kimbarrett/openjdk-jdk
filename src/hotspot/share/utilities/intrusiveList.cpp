...
const IntrusiveListImpl* IntrusiveListImpl::entry_list(const IntrusiveListEntry& entry) {
  // Ensure consistency.
...
void IntrusiveListImpl::set_entry_list(const IntrusiveListEntry& entry, IntrusiveListImpl* list) {
  entry._list = list;
}
