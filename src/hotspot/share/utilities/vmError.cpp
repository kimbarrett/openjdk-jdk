...
void VMError::report_and_die(int id, const char* message, const char* detail_fmt, va_list detail_args,
  ...
  report_and_maybe_die(AfterReportAction::Die,
...
void VMError::report_and_maybe_die(AfterReportAction after_report_action,
  ...
  va_list detail_args;
  va_start(detail_args, detail_fmt);
  report_and_maybe_die(after_report_action,
...
void VMError::report_and_maybe_die(AfterReportAction after_report_action,
                                   int id, const char* message, const char* detail_fmt, va_list detail_args,
                                   Thread* thread, address pc, void* siginfo, void* context, const char* filename,
                                   int lineno, size_t size)
{
  ...
  if (after_report_action == AfterReportAction::Die) {
#ifdef _WINDOWS
  ...
  assert(after_report_action == AfterReportAction::Return, "invariant");
}
